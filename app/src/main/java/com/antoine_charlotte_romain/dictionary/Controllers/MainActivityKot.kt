...
class MainActivityKot : AppCompatActivity() {
    ...
    private var myMenuDrawerList: RecyclerView? = null
    private var myMenuDrawerLayout: DrawerLayout? = null
    private var myMenuDrawerToggle: ActionBarDrawerToggle? = null
    private var myMenuAdapter: DrawerAdapter? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val myPlanetTitles = arrayOf(getString(R.string.language), getString(R.string.about))
        val icons = intArrayOf(R.drawable.ic_language_white_24dp, R.drawable.ic_info_white_24dp)
        myMenuDrawerLayout = findViewById(R.id.activity_main) as DrawerLayout?
        myMenuDrawerList = findViewById(R.id.left_drawer) as RecyclerView?

        // Set the adapter for the recycler view of the menu settings
        myMenuAdapter = DrawerAdapter(myPlanetTitles, icons)
        myMenuDrawerList!!.adapter = myMenuAdapter
        val mLayoutManager = LinearLayoutManager(this)
        myMenuDrawerList!!.layoutManager = mLayoutManager
