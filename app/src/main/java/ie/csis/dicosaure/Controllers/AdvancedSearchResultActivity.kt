...
import ie.csis.dicosaure.Controllers.Adapter.AdvancedSearchResultsAdapter
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (results!!.size > 0) {
            ...
            listResults!!.setOnItemClickListener(AdapterView.OnItemClickListener { parent, view, position, id ->
                val wordDetailIntent = Intent(this@AdvancedSearchResultActivity, WordView::class.java)
