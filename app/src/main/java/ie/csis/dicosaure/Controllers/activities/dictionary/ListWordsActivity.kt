package ie.csis.dicosaure.Controllers.activities.dictionary
...
import ie.csis.dicosaure.Controllers.*
import ie.csis.dicosaure.Controllers.Adapter.WordAdapter
import ie.csis.dicosaure.Controllers.Adapter.WordAdapterCallbackKot
...
import ie.csis.dicosaure.business.dictionary.Dictionary
import ie.csis.dicosaure.business.word.WordSQLITE
import ie.csis.dicosaure.utilities.KeyboardUtility
...
class ListWordsActivity() : AppCompatActivity(), AdapterView.OnItemClickListener, WordAdapterCallbackKot {
    ...
    fun newWord(view: View) {
        ...
        val newWordIntent = Intent(this, WordViewEdit::class.java)
    ...
    private fun modify(position: Int) {
        ...
        val wordDetailIntent = Intent(this, WordViewEdit::class.java)
    ...
    private fun viewWord(position: Int) {
        //TODO
        val wordDetailIntent = Intent(this, WordView::class.java)
